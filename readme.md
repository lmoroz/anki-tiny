...
5. Должна быть возможность установить время дня, с какого по какой час возможны тренировки и, приложение не дложно предлагать к изучению новые карточки, если до окончания условного текущего дня осталось меньше
